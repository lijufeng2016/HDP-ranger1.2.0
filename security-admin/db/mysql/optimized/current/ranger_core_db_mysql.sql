...
CREATE PROCEDURE `getXportalUIdByLoginId`(IN input_val VARCHAR(100), OUT myid int(11))
BEGIN SELECT x_portal_user.id into myid FROM x_portal_user
...
CREATE PROCEDURE `getModulesIdByName`(IN input_val VARCHAR(100), OUT myid int(11))
BEGIN SELECT x_modules_master.id into myid FROM x_modules_master
...
INSERT INTO x_portal_user_role(create_time,update_time,added_by_id,upd_by_id,user_id,user_role,status) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),NULL,NULL,(SELECT @adminId),'ROLE_SYS_ADMIN',1);
INSERT INTO x_group (ADDED_BY_ID, CREATE_TIME, DESCR, GROUP_SRC, GROUP_TYPE, GROUP_NAME, STATUS, UPDATE_TIME, UPD_BY_ID) VALUES ((SELECT @adminId), UTC_TIMESTAMP(), 'public group', 0, 0, 'public', 0, UTC_TIMESTAMP(), (SELECT @adminId));
...
INSERT INTO x_portal_user_role(create_time,update_time,added_by_id,upd_by_id,user_id,user_role,status) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),NULL,NULL,(SELECT @rangerusersyncId),'ROLE_SYS_ADMIN',1);
...
INSERT INTO x_portal_user_role(create_time,update_time,added_by_id,upd_by_id,user_id,user_role,status) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),NULL,NULL,(SELECT @keyadminId),'ROLE_KEY_ADMIN',1);
...
INSERT INTO x_portal_user_role(create_time,update_time,added_by_id,upd_by_id,user_id,user_role,status) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),NULL,NULL,(SELECT @rangertagsyncId),'ROLE_SYS_ADMIN',1);
...
INSERT INTO `x_modules_master` (`create_time`,`update_time`,`added_by_id`,`upd_by_id`,`module`,`url`) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Resource Based Policies',''),(UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Users/Groups',''),(UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Reports',''),(UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Audit',''),(UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Key Manager',''),(UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Tag Based Policies','');
INSERT INTO `x_modules_master` (`create_time`,`update_time`,`added_by_id`,`upd_by_id`,`module`,`url`) VALUES (UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),'Security Zone','');
CALL getModulesIdByName('Reports', @reportsId);
CALL getModulesIdByName('Resource Based Policies', @resourceBasedPoliciesId);
CALL getModulesIdByName('Audit', @auditId);
CALL getModulesIdByName('Users/Groups', @usersGroupsId);
CALL getModulesIdByName('Tag Based Policies', @tagBasedPoliciesId);
CALL getModulesIdByName('Key Manager', @keyManagerId);
CALL getModulesIdByName('Security Zone', @securityZoneId);

INSERT INTO x_security_zone(id, create_time, update_time, added_by_id, upd_by_id, version, name, jsonData, description) VALUES (1, UTC_TIMESTAMP(),UTC_TIMESTAMP(), (SELECT @adminId), (SELECT @adminId), 1, ' ', '', 'Unzoned zone');
...
VALUES ((SELECT @adminId),(SELECT @reportsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @adminId),(SELECT @resourceBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @adminId),(SELECT @auditId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @adminId),(SELECT @usersGroupsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @adminId),(SELECT @tagBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangerusersyncId),(SELECT @reportsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangerusersyncId),(SELECT @resourceBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangerusersyncId),(SELECT @auditId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangerusersyncId),(SELECT @usersGroupsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangerusersyncId),(SELECT @tagBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @keyadminId),(SELECT @keyManagerId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @keyadminId),(SELECT @reportsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @keyadminId),(SELECT @resourceBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangertagsyncId),(SELECT @reportsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangertagsyncId),(SELECT @resourceBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangertagsyncId),(SELECT @auditId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangertagsyncId),(SELECT @usersGroupsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @rangertagsyncId),(SELECT @tagBasedPoliciesId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @keyadminId),(SELECT @usersGroupsId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed)
VALUES ((SELECT @keyadminId),(SELECT @auditId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);

INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed) VALUES ((SELECT @adminId),(SELECT @securityZoneId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed) VALUES ((SELECT @rangerusersyncId),(SELECT @securityZoneId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
INSERT INTO x_user_module_perm (user_id,module_id,create_time,update_time,added_by_id,upd_by_id,is_allowed) VALUES ((SELECT @rangertagsyncId),(SELECT @securityZoneId),UTC_TIMESTAMP(),UTC_TIMESTAMP(),(SELECT @adminId),(SELECT @adminId),1);
